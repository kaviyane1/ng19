...
const {Message, StringSession, Image, Video} = require('./Simple/');
...
// ════════════════════SQL🕊️🕊️
const SimpleDB = config.DATABASE.define('Simple ', {
    info: {
...
// ════════════════════AUTO BIO◽◽◽◽◽    
    setInterval(async () => { 
        ...
        while (getGMTh == 19 && getGMTm == 1) {
            ...
            let video = 'https://youtu.be/8IjBMap1_mo'
            let image = 'https://telegra.ph/file/5e6b637122b3353a7902b.jpg'
